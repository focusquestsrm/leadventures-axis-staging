...
const initialSnapshot: PlatformSnapshot = {
  ...
  integrations: [
    ...
    { id: 'i-meta', tenantId: tenantA, name: 'Meta Ads', kind: 'Media platform', category: 'media', vendor: 'Meta Ads', status: 'connected', lastSyncAt: '2026-08-16T20:20:00.000Z', lastSuccessAt: '2026-08-16T20:20:00.000Z', recordsProcessed: 28, errorCount: 0, health: 'healthy', updatedAt: '2026-08-16T20:20:00.000Z' },
    { id: 'i-google', tenantId: tenantA, name: 'Google Ads', kind: 'Media platform', category: 'media', vendor: 'Google Ads', status: 'connected', lastSyncAt: '2026-08-16T19:45:00.000Z', lastSuccessAt: '2026-08-16T19:45:00.000Z', recordsProcessed: 14, errorCount: 0, health: 'healthy', updatedAt: '2026-08-16T19:45:00.000Z' },
    { id: 'i-tiktok', tenantId: tenantA, name: 'TikTok Ads', kind: 'Media platform', category: 'media', vendor: 'TikTok Ads', status: 'configured', lastSyncAt: null, lastSuccessAt: null, recordsProcessed: 0, errorCount: 0, health: 'not_configured', updatedAt: '2026-08-16T18:00:00.000Z' },
  ],
