...
describe('intelligence service query contract', () => {
  ...
  it('merges the tenant-authorized outcome aggregation contract', () => { expect(source).toContain("rpc('axis_outcome_intelligence_snapshot'"); expect(source).toContain('isOutcomeExtension') })
