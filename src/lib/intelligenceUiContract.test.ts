...
describe('Release 3 intelligence UI contract', () => {
  ...
  it('keeps financial values unavailable when no authoritative data exists', () => { expect(pages).toContain('Unavailable without accepted payout data'); expect(pages).toContain('Spend and CPL remain unavailable') })
